...
public class LocalDevice extends LocalDeviceImpl
{
    ...
    private LocalDevice()
    {
        ...
        try {
            ...
            bluetoothAddress = Long.toString(bluetoothPeer.getsockaddress(socket));
        ...
        bluetoothAddress = "000000000000".substring(bluetoothAddress.length())+bluetoothAddress;
    }
    ...
    */
    /*
      Retrieves Bluetooth system properties. The following properties must be supported, but additional values are allowed: Property Name Description 
    ...
    */
    ...
    public ServiceRecord getRecord(Connection notifier)
    {
        ...
        return ((BluetoothStreamConnectionNotifier)notifier).getServiceRecord();
    }
