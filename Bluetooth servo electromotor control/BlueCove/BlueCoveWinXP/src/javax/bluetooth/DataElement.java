...
public class DataElement
{
    ...
    */
    ...
    /*
      Creates a DataElement that encapsulates an integer value of size U_INT_1, U_INT_2, U_INT_4, INT_1, INT_2, INT_4, and INT_8. The legal values for the valueType and the corresponding attribute values are: Value Type Value Range 
      U_INT_1 [0, 2^8-1] 
      U_INT_2 [0, 2^16-1] 
      U_INT_4 [0, 2^32-1] 
      INT_1 [-2^7, 2^7-1] 
    ...
    */
    ...
    /*
      Creates a DataElement whose data type is given by valueType and whose value is specified by the argument value. The legal values for the valueType and the corresponding attribute values are: Value Type Java Type / Value Range 
        ...
        case DATSEQ:
            {
                ...
                for(Enumeration enum = ((Vector)value).elements(); enum.hasMoreElements(); ) {
