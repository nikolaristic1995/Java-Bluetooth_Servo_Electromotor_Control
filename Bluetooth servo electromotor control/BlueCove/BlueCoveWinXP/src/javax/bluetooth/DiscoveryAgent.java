...
public class DiscoveryAgent
{
    ...
    */
    ...
    {
        LocalDevice.getLocalDevice().getBluetoothPeer().startInquiry(accessCode, listener);

        return true;
    }

    /*
      Removes the device from inquiry mode. An inquiryCompleted() event will occur with a type of INQUIRY_TERMINATED as a result of calling this method. After receiving this event, no further deviceDiscovered() events will occur as a result of this inquiry. 
	  ...
	  TODO: Deviation from spec. We always cancel, regardless of the value of listener
    */
    ...
    public boolean cancelInquiry(DiscoveryListener listener)
    {
        ...
        return LocalDevice.getLocalDevice().getBluetoothPeer().cancelInquiry();
    }
    ...
    /*
      ...
      IllegalArgumentException - if attrSet has an illegal service attribute ID or exceeds the property bluetooth.sd.attr.retrievable.max defined in the class LocalDevice; if attrSet or uuidSet is of length 0; if attrSet or uuidSet contains duplicates
    ...
    */
    ...
    {
        LocalDevice.getLocalDevice().getBluetoothPeer().startSearchServices(attrSet, uuidSet, device, listener);
