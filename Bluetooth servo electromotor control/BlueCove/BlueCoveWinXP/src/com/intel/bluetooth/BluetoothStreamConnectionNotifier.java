...
public class BluetoothStreamConnectionNotifier implements StreamConnectionNotifier
{
    ...
    public BluetoothStreamConnectionNotifier(UUID uuid, boolean authenticate, boolean encrypt, String name) throws IOException
    {
        ...
        */
        ...
        BluetoothPeer peer = ((LocalDeviceImpl)LocalDevice.getLocalDevice()).getBluetoothPeer();
        ...
        */
        ...
        /*
          service handle (direct insert to avoid IllegalArgumentException from setAttributeValue)
        */
	
        ((ServiceRecordImpl)serviceRecord).attributes.put(new Integer(ServiceRecord.ServiceRecordHandle), new DataElement(DataElement.U_INT_4, 0x00010020));
    ...
    */
    ...
    {
        return new BluetoothConnection(((LocalDeviceImpl)LocalDevice.getLocalDevice()).getBluetoothPeer().accept(socket));
    }
