...
class BluetoothInputStream extends InputStream
{
    ...
    */
    ...
    public int read() throws IOException
    {
        if (conn == null)
            ...
            return ((LocalDeviceImpl)LocalDevice.getLocalDevice()).getBluetoothPeer().recv(conn.socket);
    }
    /*
    ...
    */
    ...
    public int read(byte[] b, int off, int len) throws IOException
    {
        ...
        if (conn == null)			throw new IOException();		else			return ((LocalDeviceImpl)LocalDevice.getLocalDevice()).getBluetoothPeer().recv(conn.socket, b, off, len);	}
