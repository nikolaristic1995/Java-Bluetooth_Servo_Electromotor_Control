...
class BluetoothOutputStream extends OutputStream
{
    ...
    */
    ...
    public void write(int b) throws IOException
    {
        if (conn == null)
            ...
            ((LocalDeviceImpl)LocalDevice.getLocalDevice()).getBluetoothPeer().send(conn.socket, b);
    }
    /*	
    ...
    */
    ...
    {		if (off < 0 || len < 0 || off+len > b.length)
        ...
        if (conn == null)			throw new IOException();		else			((LocalDeviceImpl)LocalDevice.getLocalDevice()).getBluetoothPeer().send(conn.socket, b, off, len);	}		
