...
public class SDPInputStream extends FilterInputStream
{
    ...
    private String readBytes(int size) throws IOException
    {
        ...
        case 3:			// UUID
            {
                ...
                case 2:
                    ...
                    break;
                case 4:
                    uuid = new UUID(readBytes(16), true);
                    break;
                default:
                    throw new IOException();
                }
